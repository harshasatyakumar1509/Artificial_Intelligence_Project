...
def less(a, b):
    ...
    '''Included in order to handle integers. Otherwise, no way to evaluate rules such as "Current greater than 5"'''
    if isinstance(a, int):
        a = number_to_value(a)
    if isinstance(b, int):
        b = number_to_value(b)
    '''Changes made by Rule Breakers_____________________________________________________________________________'''
